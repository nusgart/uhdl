...
create_clock -add -name sys_clk_pin -period 8.00 -waveform {0 4} [get_ports { sysclk }];#set
...
set_property -dict { PACKAGE_PIN D19    IOSTANDARD LVCMOS33 } [get_ports { switch[0] }]; #IO_L4P_T0_35 Sch=BTN0
set_property -dict { PACKAGE_PIN D20    IOSTANDARD LVCMOS33 } [get_ports { switch[1] }]; #IO_L4N_T0_35 Sch=BTN1
set_property -dict { PACKAGE_PIN L20    IOSTANDARD LVCMOS33 } [get_ports { switch[2] }]; #IO_L9N_T1_DQS_AD3N_35 Sch=BTN2
set_property -dict { PACKAGE_PIN L19    IOSTANDARD LVCMOS33 } [get_ports { switch[3] }]; #IO_L9P_T1_DQS_AD3P_35 Sch=BTN3
...
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { vga_r }]; #IO_L5P_T0_34 Sch=CK_IO0
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { vga_g }]; #IO_L2N_T0_34 Sch=CK_IO1
set_property -dict { PACKAGE_PIN U13   IOSTANDARD LVCMOS33 } [get_ports { vga_b }]; #IO_L3P_T0_DQS_PUDC_B_34 Sch=CK_IO2
set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports { vga_hsync }]; #IO_L3N_T0_DQS_34 Sch=CK_IO3
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports { vga_vsync }]; #IO_L10P_T1_34 Sch=CK_IO4
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports { usb_rxd }]; #IO_L5N_T0_34 Sch=CK_IO5
set_property -dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33 } [get_ports { usb_txd }]; #IO_L19P_T3_34 Sch=CK_IO6
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { ms_ps2_clk }]; #IO_L9N_T1_DQS_34 Sch=CK_IO7
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { ms_ps2_data }]; #IO_L21P_T3_DQS_34 Sch=CK_IO8
set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33 } [get_ports { ps2_clk }]; #IO_L21N_T3_DQS_34 Sch=CK_IO9
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { ps2_data }]; #IO_L9P_T1_DQS_34 Sch=CK_IO10
...
set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS33 } [get_ports { mmc_di }]; #IO_L10N_T1_34 Sch=CK_MISO
set_property -dict { PACKAGE_PIN T12   IOSTANDARD LVCMOS33 } [get_ports { mmc_do }]; #IO_L2P_T0_34 Sch=CK_MOSI
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { mmc_sclk }];  #IO_L19P_T3_35 Sch=CK_SCK
set_property -dict { PACKAGE_PIN F16   IOSTANDARD LVCMOS33 } [get_ports { mmc_cs }];   #IO_L6P_T0_35 Sch=CK_SS
