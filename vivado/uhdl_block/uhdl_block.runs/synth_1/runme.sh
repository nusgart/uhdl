...
HD_PWD='D:/FPGA/cadr/projects/uhdl_zynq/uhdl_zynq.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cadr_unit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cadr_unit.tcl
