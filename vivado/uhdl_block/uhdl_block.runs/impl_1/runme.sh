...
HD_PWD='D:/FPGA/cadr/projects/uhdl_zynq/uhdl_zynq.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cadr_unit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cadr_unit.tcl -notrace
