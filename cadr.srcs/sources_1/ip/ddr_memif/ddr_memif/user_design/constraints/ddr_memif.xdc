...
# PadFunction:  
set_property IOSTANDARD SSTL15 [get_ports {clk_ref_i}]
set_property PACKAGE_PIN E11 [get_ports {clk_ref_i}]

# PadFunction:  
set_property IOSTANDARD LVCMOS25 [get_ports {sys_rst}]
set_property PACKAGE_PIN A2 [get_ports {sys_rst}]
...
set_property PACKAGE_PIN C12 [get_ports {ddr3_dqs_p[0]}]
...
set_property PACKAGE_PIN B12 [get_ports {ddr3_dqs_n[0]}]
