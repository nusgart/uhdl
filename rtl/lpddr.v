// lpddr.v --- wrapper for Coregen memory controller
...
`ifdef XILINX_ISIM
     ...
     parameter C3_MC_CALIB_BYPASS = "YES",
`else
...
`endif
   ...
   localparam C3_PORT_ENABLE = 6'b0000001;
   ...
   assign c3_p1_cmd_en = 0;
   assign c3_p1_cmd_instr = 0;
   assign c3_p1_cmd_bl = 0;
   assign c3_p1_cmd_byte_addr = 0;

   assign c3_p2_cmd_clk = 0;
   assign c3_p2_cmd_en = 0;
   assign c3_p2_cmd_instr = 0;
   assign c3_p2_cmd_bl = 0;
   assign c3_p2_cmd_byte_addr = 0;

   assign c3_p3_cmd_clk = 0;
   assign c3_p3_cmd_en = 0;
   assign c3_p3_cmd_instr = 0;
   assign c3_p3_cmd_bl = 0;
   assign c3_p3_cmd_byte_addr = 0;

   assign c3_p4_cmd_clk = 0;
   assign c3_p4_cmd_en = 0;
   assign c3_p4_cmd_instr = 0;
   assign c3_p4_cmd_bl = 0;
   assign c3_p4_cmd_byte_addr = 0;

   assign c3_p5_cmd_clk = 0;
   assign c3_p5_cmd_en = 0;
   assign c3_p5_cmd_instr = 0;
   assign c3_p5_cmd_bl = 0;
   assign c3_p5_cmd_byte_addr = 0;
